...
def fieldcount(pobject, field):
    """ Helper-func - use countnodes to count the occurrences of field in pobject

        example
        count the occurrences of domainid in this single record...
...
def subnodecount(pobject, subnode):
    """ Helper-func - use countnodes to count subnode in pobject
        ...
        example
        count the occurrences of domainid in this json.
